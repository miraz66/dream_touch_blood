    ...
    <>
      <div className="pb-20 bg-gray-50">
        ...
        <div className="max-w-7xl md:mx-5 2xl:mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 justify-between gap-5 2xl:gap-10 px-5">
            <div className="py-10 flex flex-col items-center text-center bg-white hover:shadow-xl ease-in-out duration-300 rounded-md">
              <FontAwesomeIcon
