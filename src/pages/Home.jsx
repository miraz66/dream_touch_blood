    ...
    <>
      <div className="h-screen bg-white overflow-hidden max-md:p-2">
        <div className="max-w-6xl mx-auto">
          <img
            className="w-[250px] md:w-[300px] lg:w-[400px] mx-auto pt-10"
            src={MainPhoto}
            alt=""
          />
          ...
          <p className="2xl:pt-5 md:text-2xl text-center text-gray-600 font-semibold ">
            Elipur,Rupsha,Khulna
          </p>

          <div className="flex justify-center 2xl:mt-20 mt-10">
